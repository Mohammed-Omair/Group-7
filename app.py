...
import requests
from push import write_to_firestore, prev_ques
import push
...
## -------------------------------------------------------------------------------------------------
    ...
    with st.sidebar:
            if previous_questions:
                ...
                for question in previous_questions:
                    #st.write(f"{question['text1']}")
                    #st.write(f"{question['text2']}")
                    #st.write(f"Similarity score: {question['similarity_score']}")
    ...
    textbox1 = st.text_input("Enter first text:")
    textbox2 = st.text_input("Enter second text:")
    ...
    if button:
        ...
        # Set the API headers
        headers = {
            "X-RapidAPI-Key": "97576d9880mshb117b8484525bbap1e00a9jsn4e00ac413307",
